...
import { Activity, Stethoscope, BookOpen, HeartPulse, Video, ShoppingBag, AlertTriangle, SmilePlus, Users, FolderOpen, ScanLine, Smile, Globe, ChevronDown, LogIn, User, LogOut } from "lucide-react";
import {
  NavigationMenu,
          ...
          {user ? (
            <div className="relative" ref={userMenuRef}>
              ...
              >
                ...
                <ChevronDown className={cn("h-3 w-3 text-slate-400 transition-transform duration-200", userMenuOpen && "rotate-180")} />
              </button>
