  ...
  head: () => ({
    meta: [
      { title: "Cek Gejala — Sembuhin" },
      {
        name: "description",
        content:
          "Masukkan gejala Anda, dapatkan klasifikasi urgensi dan rekomendasi tindakan yang tepat.",
      },
    ],
  }),
...
function SymptomTriagePage() {
  ...
  const analyze = useCallback(async () => {
    ...
    if (!isMedicalInput(input)) {
      setErrorMessage(
        'Maaf, sepertinya Anda tidak memasukkan gejala medis. Mohon ceritakan keluhan kesehatan Anda dengan jelas (misal: "demam tinggi", "sakit kepala", dll).',
      );
      setAnalyzing(false);
      return;
    }
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full bg-sky-100/80 border border-sky-200/60 px-5 py-2 mb-6">
            ...
            <span className="text-xs font-semibold text-sky-700 tracking-wide uppercase">
              AI Symptom Checker 1.3 (Sembuhin 1.3)
            </span>
          </div>
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-display font-bold text-slate-900 leading-tight tracking-tight">
            Cek Tingkat Urgensi
            <br className="hidden sm:block" /> Kesehatan Anda
          </h1>
          <p className="mt-5 text-base sm:text-lg text-slate-500 leading-relaxed max-w-2xl mx-auto">
            Ceritakan keluhan yang Anda rasakan. Sistem AI kami akan membantu mengklasifikasikan
            tingkat urgensi dan memberikan langkah penanganan yang tepat secara real-time.
          </p>
          ...
          <div className="flex flex-wrap justify-center items-center gap-4 mt-8">
            {[
              ...
              <div
                key={label}
                className="flex items-center gap-2 rounded-full glass px-4 py-2 text-xs font-medium text-slate-600 shadow-sm"
              >
        ...
        >
          ...
          <div className="flex-1">
            ...
            <p className="text-xs sm:text-sm text-slate-600 mt-1">
              Jika mengalami sesak napas berat, nyeri dada hebat, atau pingsan — segera hubungi
              layanan darurat.
            </p>
          </div>
          <a
            href="tel:119"
            className="shrink-0 inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 px-5 py-3 text-sm font-bold text-white transition-all shadow-lg shadow-red-600/30 hover:scale-105 active:scale-95"
          >
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-500">
                      Ceritakan gejala yang Anda rasakan sedetail mungkin
                    </p>
                  </div>
                </div>
            ...
            <AnimatePresence mode="wait">
                  ...
                  <div className="flex items-center gap-5">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500 mt-1">
                        Menganalisis dengan AI Sembuhin 1.3...
                      </p>
                    </div>
                  </div>
                </motion.div>
              ...
              {result && !analyzing && (
                ...
                >
                  ...
                  <div
                    className={cn(
                      "glass-strong rounded-3xl border overflow-hidden shadow-xl",
                      URGENCY[result.urgency!].light,
                    )}
                  >
                    <div className="p-7 sm:p-8">
                      <div className="flex items-start justify-between gap-5">
                        <div className="flex items-center gap-4">
                          <div
                            className={cn(
                              "flex h-14 w-14 items-center justify-center rounded-2xl text-white shadow-xl bg-gradient-to-br",
                              URGENCY[result.urgency!].bg,
                            )}
                          >
                            {(() => {
                              const Icon = URGENCY[result.urgency!].icon;
                  ...
                  <div className="glass-strong rounded-3xl border border-sky-100/50 shadow-xl shadow-sky-900/5 overflow-hidden">
                    ...
                    <div className="p-7 bg-gradient-to-r from-slate-50 to-sky-50 border-t border-slate-100 flex flex-col sm:flex-row gap-4">
                      ...
                      {result.urgency === "emergency" && (
                        <a
                          href="tel:119"
                          className="flex-1 flex items-center justify-center gap-2.5 rounded-2xl bg-gradient-to-r from-red-600 to-red-700 px-6 py-3.5 text-sm font-bold text-white hover:from-red-700 hover:to-red-800 transition-all shadow-lg shadow-red-600/20 hover:shadow-xl hover:scale-105 active:scale-95"
                        >
                  ...
                  <div className="flex gap-3.5 rounded-2xl glass border border-slate-200/50 p-5 shadow-sm">
                    ...
                    <p className="text-xs text-slate-500 leading-relaxed">
                      Hasil pemeriksaan ini bersifat informatif dan bukan pengganti diagnosis medis
                      profesional. Selalu konsultasikan kondisi Anda dengan dokter.
                    </p>
                  </div>
                </motion.div>
              )}
                ...
                {[
                  {
                    n: "1",
                    t: "Ceritakan keluhan",
                    d: "Tulis atau pilih gejala yang Anda rasakan",
                  },
