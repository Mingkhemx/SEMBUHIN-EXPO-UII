...
export const Route = createFileRoute("/auth")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Masuk atau daftar akun Sembuhin untuk akses layanan kesehatan lengkap.",
      },
    ],
  }),
  component: AuthPage,
      ...
      const { error } = await supabase.auth.signUp({
        ...
        options: {
          data: {
            ...
            phone: registerPhone,
            chat_limit: 10, // Default 10 chat per day
          },
        },
      });
      if (error) {
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-sky-100">
                      Konsultasi dan layanan kesehatan kapan saja
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-sky-100">
                      Semua kebutuhan kesehatan dalam satu platform
                    </p>
                  </div>
                </div>
              </div>
