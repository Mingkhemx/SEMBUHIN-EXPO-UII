...
export const Route = createFileRoute("/artikel")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Kumpulan riset dan artikel medis terpercaya untuk kesehatan Anda.",
      },
    ],
  }),
...
const ARTICLES: Article[] = [
  {
    ...
    excerpt:
      "Memasuki usia 30-an, risiko penyakit kardiovaskular mulai meningkat. Pelajari langkah-langkah pencegahan yang efektif berdasarkan riset terkini.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Kolesterol LDL yang tinggi bisa meningkatkan risiko stroke dan serangan jantung. Simak daftar makanan yang terbukti secara ilmiah menurunkan LDL.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Dua pendekatan olahraga ini memiliki manfaat berbeda. Temukan mana yang paling cocok untuk tujuan kebugaran Anda.",
    content:
  ...
  },
  {
    ...
    excerpt:
      "Riset terbaru menunjukkan diabetes tipe 2 stadium awal bisa direversal dengan perubahan gaya hidup yang tepat.",
    content:
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="text-xs text-slate-400">
                  {loading ? "Memuat..." : `${filteredArticles.length} artikel`}
                </span>
              </div>
                    ...
                    >
                      ...
                      <div className="h-48 bg-slate-100 flex items-center justify-center text-4xl border-b border-slate-100 overflow-hidden relative">
                        {article.imageUrl ? (
                          ...
                          <span className="text-5xl drop-shadow-sm transition-transform duration-300 group-hover:scale-110 z-0">
                            {article.imageEmoji}
                          </span>
                        )}
                      ...
                      <div className="p-5">
                        ...
                        <h3 className="text-sm font-bold text-slate-800 leading-snug group-hover:text-sky-700 transition-colors line-clamp-2">
                          {article.title}
                        </h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 flex-wrap pt-2">
                ...
                <div className="flex items-center gap-4 text-xs text-slate-400 ml-auto">
                  ...
                  <span className="flex items-center gap-1">
                    <Eye className="h-3 w-3" /> {selectedArticle.views.toLocaleString()}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-12 shadow-xl shadow-sky-900/5 border border-slate-100">
                ...
                {selectedArticle.content.split("\n\n").map((para, i) => {
                  ...
                  if (isList) {
                    ...
                    return (
                      <div
                        key={i}
                        className="mb-8 mt-10 bg-slate-50 rounded-2xl p-6 border border-slate-100"
                      >
                        <h3 className="text-xl font-bold text-slate-800 mb-3 flex items-start gap-3">
                          <span className="flex-shrink-0 flex items-center justify-center w-8 h-8 rounded-full bg-sky-600 text-white text-sm shadow-md shadow-sky-600/20">
                            {number.replace(".", "")}
                          </span>
                  ...
                  if (isHeading) {
                    return (
                      <h3
                        key={i}
                        className="text-2xl font-bold text-slate-800 mt-10 mb-4 pb-2 border-b border-slate-100"
                      >
                        {para}
                      </h3>
                    );
                  ...
                  return (
                    <p key={i} className="text-slate-600 leading-relaxed mb-6 text-justify text-lg">
                      {para}
                    </p>
                  );
                })}
              ...
              <div className="flex items-center gap-2 flex-wrap pt-8 mt-4 border-t border-slate-100">
                ...
                {["kesehatan", selectedArticle.category, "edukasi", "gaya hidup"].map((tag) => (
                  <span
                    key={tag}
                    className="text-[11px] font-medium px-3 py-1.5 rounded-full bg-slate-50 text-slate-600 border border-slate-200 hover:bg-sky-50 hover:text-sky-600 hover:border-sky-200 transition-colors cursor-pointer"
                  >
                    #{tag}
                  </span>
                ))}
                ...
                {ARTICLES.filter(
                  ...
                  .map((article) => (
                    <button
                      ...
                      className="rounded-xl bg-white border border-white/60 shadow-sm hover:shadow-md transition-all text-left p-4 group"
                    >
                      <div className="text-2xl mb-2">{article.imageEmoji}</div>
                      <p className="text-xs font-bold text-slate-800 group-hover:text-sky-700 transition-colors line-clamp-2">
                        {article.title}
                      </p>
