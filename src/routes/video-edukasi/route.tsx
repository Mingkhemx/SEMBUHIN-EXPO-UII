...
export const Route = createFileRoute("/video-edukasi")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Konten visual interaktif mengenai pencegahan penyakit dan kesehatan.",
      },
    ],
  }),
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 space-y-14">
        ...
        {selectedVideo ? (
          ...
          >
            ...
            {/* Video Player */}
            <div
              className="rounded-2xl overflow-hidden bg-slate-900 shadow-2xl"
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4 flex-wrap text-xs text-slate-400">
                <span className="flex items-center gap-1">
                  <Eye className="h-3 w-3" /> {formatViews(selectedVideo.views)} views
                </span>
                <span className="flex items-center gap-1">
                  <Clock className="h-3 w-3" /> {selectedVideo.duration}
                </span>
                <span className="flex items-center gap-1">
                  <BookOpen className="h-3 w-3" /> {selectedVideo.publishedDate}
                </span>
              </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  >
                    <Bookmark
                      className={cn(
                        "h-3.5 w-3.5",
                        savedVideos.includes(selectedVideo.id) && "fill-current",
                      )}
                    />
                ...
                {VIDEOS.filter(
                  ...
                  .map((video) => (
                    <button
                      ...
                      className="rounded-xl bg-white border border-white/60 shadow-sm hover:shadow-md transition-all text-left overflow-hidden group"
                    >
              ...
              <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredVideos.map((video) => (
                  ...
                  >
                    <VideoThumbnail
                      video={video}
                      className="h-40 text-5xl border-b border-slate-100"
                    />
                    <div className="p-4">
