...
const EMOTION_MAP: Record<string, Omit<MoodDetection, "pct">> = {
  happy: {
    ...
    description: "Ekspresi positif terdeteksi",
    rawKey: "happy",
  },
  calm: {
    emotion: "Tenang",
    icon: Meh,
    color: "text-sky-600",
    description: "Wajah rileks dan stabil",
    rawKey: "calm",
  },
  neutral: {
    emotion: "Netral",
    ...
    description: "Tanpa ekspresi dominan",
    rawKey: "neutral",
  },
  fearful: {
    emotion: "Cemas",
    ...
    description: "Tanda ketegangan terdeteksi",
    rawKey: "fearful",
  },
  sad: {
    emotion: "Sedih",
    ...
    description: "Indikasi kesedihan terdeteksi",
    rawKey: "sad",
  },
  angry: {
    emotion: "Marah",
    icon: Frown,
    color: "text-red-600",
    description: "Ekspresi kemarahan terdeteksi",
    rawKey: "angry",
  },
  disgusted: {
    emotion: "Jijik",
    ...
    description: "Ekspresi tidak suka terdeteksi",
    rawKey: "disgusted",
  },
  surprised: {
    emotion: "Terkejut",
    ...
    description: "Ekspresi terkejut terdeteksi",
    rawKey: "surprised",
  },
  tired: {
    emotion: "Lelah",
    ...
    description: "Kelelahan terdeteksi",
    rawKey: "tired",
  },
};
...
const MOOD_CONFIG: Record<
  MoodLevel,
  { label: string; color: string; bgColor: string; emoji: string; desc: string }
> = {
  happy: {
    label: "Senang",
    ...
    emoji: "😊",
    desc: "Anda terlihat dalam kondisi emosional yang baik!",
  },
  calm: {
    label: "Tenang",
    color: "text-sky-700",
    ...
    emoji: "😌",
    desc: "Anda tampak tenang dan rileks.",
  },
  neutral: {
    label: "Netral",
    ...
    emoji: "😐",
    desc: "Ekspresi Anda netral saat ini.",
  },
  anxious: {
    label: "Cemas",
    ...
    emoji: "😰",
    desc: "Terdeteksi tanda-tanda kecemasan.",
  },
  sad: {
    label: "Sedih",
  ...
  angry: {
    ...
    emoji: "😠",
    desc: "Terdeteksi ekspresi kemarahan.",
  },
  tired: {
    label: "Lelah",
...
const MOOD_ACTIVITIES: Record<MoodLevel, MoodResult["activities"]> = {
  happy: [
    {
      ...
      desc: "Pertahankan mood positif",
      icon: Sun,
      duration: "15 min",
    },
    {
      title: "Journaling Syukur",
      desc: "Tulis 3 hal yang Anda syukuri",
      icon: BookOpen,
      duration: "10 min",
    },
    {
      title: "Musik Favorit",
      desc: "Dengarkan playlist favorit Anda",
      icon: Music,
      duration: "20 min",
    },
    {
      title: "Hubungi Teman",
      desc: "Ceritakan kabar baik ke orang terdekat",
      icon: Users,
      duration: "15 min",
    },
  ],
  calm: [
    {
      ...
      desc: "Pertahankan ketenangan",
      icon: Brain,
      duration: "10 min",
    },
    {
      title: "Journaling",
      desc: "Refleksi pikiran saat tenang",
      icon: BookOpen,
      duration: "15 min",
    },
    {
      title: "Musik Lo-fi",
      desc: "Iringi produktivitas dengan musik tenang",
      icon: Music,
      duration: "30 min",
    },
    {
      title: "Stretching",
      desc: "Regangkan tubuh untuk menjaga energi",
      icon: Sparkles,
      duration: "10 min",
    },
  ],
  neutral: [
    {
      title: "Jalan Santai",
      desc: "Tingkatkan mood dengan gerakan ringan",
      icon: Sun,
      duration: "15 min",
    },
    {
      title: "Baca Buku",
      desc: "Isi waktu dengan bacaan menarik",
      icon: BookOpen,
      duration: "20 min",
    },
    {
      title: "Hubungi Sahabat",
      desc: "Obrolan ringan bisa meningkatkan mood",
      icon: Users,
      duration: "15 min",
    },
    {
      title: "Musik Upbeat",
      desc: "Playlist ceria untuk membangkitkan semangat",
      icon: Music,
      duration: "20 min",
    },
  ],
  anxious: [
    {
      ...
      desc: "Tarik 4 detik, tahan 7, hembuskan 8",
      icon: Wind,
      duration: "5 min",
    },
    {
      title: "Grounding 5-4-3-2-1",
      desc: "Fokus ke 5 benda, 4 suara, 3 sentuhan",
      icon: Brain,
      duration: "3 min",
    },
    {
      title: "Jalan di Alam",
      desc: "Alam terbukti menurunkan kortisol",
      icon: Sun,
      duration: "20 min",
    },
    {
      title: "Teh Chamomile",
      desc: "Herbal untuk menenangkan sistem saraf",
      icon: Heart,
      duration: "10 min",
    },
  ],
  sad: [
    {
      title: "Jalan di Alam",
      desc: "Alam meningkatkan mood secara alami",
      icon: Sun,
      duration: "20 min",
    },
    {
      title: "Hubungi Orang Terdekat",
      desc: "Berbagi meringankan beban emosional",
      icon: Users,
      duration: "15 min",
    },
    {
      title: "Journaling Perasaan",
      desc: "Tulis apa yang Anda rasakan",
      icon: BookOpen,
      duration: "15 min",
    },
    {
      title: "Musik yang Disukai",
      desc: "Musik menemani dan mengangkat perasaan",
      icon: Music,
      duration: "20 min",
    },
  ],
  angry: [
    {
      title: "Napas Kotak",
      desc: "Tarik 4s, tahan 4s, hembuskan 4s",
      icon: Wind,
      duration: "5 min",
    },
    {
      title: "Olahraga Ringan",
      desc: "Lepaskan energi negatif lewat fisik",
      icon: Sparkles,
      duration: "15 min",
    },
    ...
    {
      title: "Jalan Cepat",
      desc: "Aerobik menurunkan hormon stres",
      icon: Sun,
      duration: "15 min",
    },
  ],
  tired: [
    { title: "Power Nap", desc: "Tidur 20 menit untuk recharge", icon: Heart, duration: "20 min" },
    {
      ...
      desc: "Regangkan otot leher & punggung",
      icon: Sparkles,
      duration: "10 min",
    },
    {
      title: "Air Putih & Snack",
      desc: "Dehidrasi sering menyebabkan lelah",
      icon: Wind,
      duration: "5 min",
    },
    {
      title: "Musik Energik",
      desc: "Upbeat membantu melawan ngantuk",
      icon: Music,
      duration: "15 min",
    },
  ],
...
const MOOD_RECO_DETAIL: Record<MoodLevel, MoodRecoDetail> = {
  happy: {
    ...
    tips: ["Bagikan kebahagiaan ke orang-orang terdekat", "Catat hal baik hari ini"],
  },
  calm: {
    ...
    tips: ["Kerjakan tugas penting sekarang", "Meditasi singkat memperkuat ketenangan"],
  },
  neutral: {
    ...
    tips: ["Coba satu hal baru hari ini", "Gerakan fisik ringan terbukti meningkatkan mood"],
  },
  anxious: {
    quote: "Kamu sudah melewati 100% hari-hari terberatmu.",
    quoteAuthor: "Anonim",
    context: "Tenangkan dirimu dulu",
    accentColor: "bg-amber-50",
    accentText: "text-amber-800",
    accentBorder: "border-amber-200",
    priorityLabel: "🫁 Mulai dari napas dulu",
    tips: ["Tarik napas 4 detik, tahan 4, hembuskan 4", "Batasi media sosial sementara"],
  },
  sad: {
    quote: "Tidak apa-apa untuk tidak baik-baik saja.",
    quoteAuthor: "Anonim",
    context: "Peluk perasaanmu",
    accentColor: "bg-indigo-50",
    accentText: "text-indigo-800",
    accentBorder: "border-indigo-200",
    priorityLabel: "💙 Yang kamu butuhkan sekarang",
    tips: ["Cerita ke orang yang kamu percaya", "Beri dirimu izin merasakannya"],
  },
  angry: {
    quote: "Kemarahan yang dikelola bijak bisa jadi bahan bakar perubahan.",
    quoteAuthor: "Anonim",
    context: "Salurkan energimu",
    accentColor: "bg-red-50",
    accentText: "text-red-800",
    accentBorder: "border-red-200",
    priorityLabel: "🔥 Lepaskan dulu",
    tips: ["Jangan buat keputusan saat masih marah", "Gerak fisik meredakan amarah tercepat"],
  },
  tired: {
    ...
    tips: ["Power nap 20 menit lebih efektif dari kafein", "Jauhkan layar 30 menit sebelum tidur"],
  },
};
...
function MoodCheckPage() {
  ...
  const [moodHistory, setMoodHistory] = useState<
    { id: number; created_at: string; mood: MoodLevel; confidence: number }[]
  >([]);
  ...
  const saveResult = useCallback(
    async (r: MoodResult) => {
      ...
      await supabase
        .from("mood_history")
        .insert({ user_id: user.id, mood: r.primaryMood, confidence: r.confidence });
      fetchHistory();
    },
    [user, fetchHistory],
  );
  ...
  const startScan = useCallback(async () => {
    ...
    const tick = async () => {
      ...
      setScanning(false);
      if (!ai) {
        setError("Analisis gagal. Pastikan koneksi internet stabil.");
        return;
      }
      if (!ai.faceDetected) {
        setFaceFound(false);
        setScanProgress(0);
        setError("Tidak ada wajah terdeteksi. Pastikan wajah Anda terlihat jelas, lalu coba lagi.");
        return;
      }
      const finalDets: MoodDetection[] = Object.entries(ai.emotions)
        .filter(([k]) => EMOTION_MAP[k])
        .map(([k, v]) => ({ ...EMOTION_MAP[k], pct: Math.round(v * 100) }))
        .sort((a, b) => b.pct - a.pct);
          ...
          >
            ...
            <div className="relative p-7 sm:p-10 lg:p-12">
              ...
              <p className="mt-4 text-sm sm:text-base text-white/80 leading-relaxed max-w-xl">
                AI menganalisis ekspresi wajah Anda untuk mendeteksi kondisi emosional dan
              ...
              <div className="mt-8 flex flex-wrap items-center gap-3">
                {(
                  ...
                  >
                    ...
                    {label}
                    {viewMode === key && (
                      <div className="h-1.5 w-1.5 rounded-full bg-cyan-400 ml-1" />
                    )}
                  </button>
                ))}
              </div>
              ...
              >
                    ...
                    <div className="flex-1 min-w-0">
                      <p
                        className={cn(
                          ...
                          error.includes("wajah") ? "text-amber-800" : "text-rose-800",
                        )}
                      >
                      ...
                      <p
                        className={cn(
                          ...
                          error.includes("wajah") ? "text-amber-700" : "text-rose-700",
                        )}
                      >
                        {error}
                      </p>
                ...
                {!cameraActive ? (
                  ...
                  <div className="space-y-0">
                    <div
                      className="relative rounded-t-2xl overflow-hidden shadow-2xl bg-black"
                      ...
                      {scanning && (
                        <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 flex flex-col items-center gap-3 px-8 pointer-events-none">
                          <div className="relative flex items-center justify-center">
                            <svg
                              className="w-32 h-32 -rotate-90 drop-shadow-xl"
                              viewBox="0 0 112 112"
                            >
                              <circle
                                cx="56"
                            ...
                            <div className="absolute flex flex-col items-center">
                              {scanProgress < 100 ? (
                                ...
                                >
                                  ...
                                  <span className="text-[10px] text-emerald-200 font-semibold mt-1">
                                    Selesai!
                                  </span>
                                </motion.div>
                              )}
                          ...
                          {scanning ? (
                            <>
                              ...
                              <span className="text-[10px] font-semibold text-cyan-600">
                                {Math.round((scanProgress * 30) / 100)} frame dianalisis
                              </span>
                            </>
                            ...
                            <>
                              ...
                              <span className="text-[10px] font-semibold text-amber-600">
                                Auto-scan dalam {autoCountdown}s...
                              </span>
                            </>
                          ) : (
              ...
              >
                <div
                  className={cn(
                    ...
                    MOOD_CONFIG[moodResult.primaryMood].bgColor,
                  )}
                >
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          <p
                            className={cn(
                              "text-lg font-bold",
                              MOOD_CONFIG[moodResult.primaryMood].color,
                            )}
                          >
                            Mood: {MOOD_CONFIG[moodResult.primaryMood].label}
                          </p>
                          <span className="text-xs text-slate-500">
                            • Akurasi {moodResult.confidence}%
                          </span>
                          {geminiUsed && (
                ...
                <div className="rounded-2xl bg-white border border-white/60 shadow-lg p-6">
                  ...
                  <p className="text-[11px] text-slate-400 mt-2 flex items-center gap-1">
                    <Sparkles className="h-3 w-3 text-violet-400" /> Dianalisis oleh Sembuhin Vision
                    1.5
                  </p>
                </div>
                {/* Emotions breakdown */}
                    ...
                    {moodResult.detections.slice(0, 5).map((det, i) => {
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            "flex items-center gap-3 p-3 rounded-xl border",
                            i === 0 ? "bg-cyan-50 border-cyan-200" : "bg-slate-50 border-slate-100",
                          )}
                        >
                          <Icon
                            className={cn(
                ...
                <div className="rounded-2xl bg-white border border-white/60 shadow-lg overflow-hidden">
                  ...
                  >
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      >
                        {MOOD_CONFIG[moodResult.primaryMood].emoji}{" "}
                        {MOOD_CONFIG[moodResult.primaryMood].label}
                      </span>
                    </div>
                    <div
                      className={cn(
                        ...
                        <div key={i} className="flex items-start gap-2">
                          <div
                            className={cn(
                              ...
                              moodResult.primaryMood === "happy"
                                ? "bg-emerald-400"
                                : moodResult.primaryMood === "calm"
                                  ? "bg-sky-400"
                                  : moodResult.primaryMood === "neutral"
                                    ? "bg-slate-400"
                                    : moodResult.primaryMood === "anxious"
                                      ? "bg-amber-400"
                                      : moodResult.primaryMood === "sad"
                                        ? "bg-indigo-400"
                                        : moodResult.primaryMood === "angry"
                                          ? "bg-red-400"
                                          : "bg-violet-400",
                            )}
                          />
                ...
                <div className="flex gap-3">
                  <button
                    onClick={resetAll}
                    className="flex-1 flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 shadow-sm"
                  >
                ...
                <div className="flex gap-3 rounded-xl bg-white/80 border border-slate-200/80 p-4 shadow-sm">
                  ...
                  <p className="text-xs text-slate-500 leading-relaxed">
                    Mood check bersifat indikatif dan bukan pengganti evaluasi psikologis
                    profesional.
                  </p>
                </div>
              </motion.div>
                    ...
                    <div>
                      ...
                      <p className="text-[11px] text-slate-400">
                        {moodHistory.length > 0
                          ? `${moodHistory.length} sesi tercatat`
                          : "Belum ada sesi"}
                      </p>
                    </div>
                  </div>
                ...
                {historyLoading ? (
                  ...
                  <div className="rounded-2xl bg-white border border-white/60 shadow-lg p-10 text-center">
                    ...
                    <p className="text-xs text-slate-400 mb-5">
                      Lakukan cek mood pertama Anda untuk melihat riwayat di sini
                    </p>
                    <button
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="hidden sm:flex flex-col items-end gap-1 shrink-0 w-24">
                            ...
                            <span className={cn("text-xs font-bold", conf.color)}>
                              {entry.confidence}%
                            </span>
                          </div>
                        </motion.div>
