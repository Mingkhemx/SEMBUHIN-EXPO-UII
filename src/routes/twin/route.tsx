  ...
  head: () => ({
    meta: [
      { title: "Health Twin 3D — Sembuhin" },
      {
        name: "description",
        content:
          "Avatar 3D digital twin tubuh kamu. Putar, zoom, dan klik organ untuk info detail.",
      },
    ],
  }),
  component: TwinPage,
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 space-y-10">
        ...
        <motion.header variants={fadeIn} initial="hidden" animate="visible" className="max-w-2xl">
          ...
          <p className="mt-3 text-base sm:text-lg text-slate-500 leading-relaxed max-w-lg">
            Salinan digital tubuh Anda yang hidup. Putar, zoom, dan jelajahi organ secara
            interaktif.
          </p>
        </motion.header>
          ...
          >
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 0 80px rgba(56, 128, 255, 0.06), inset 0 1px 0 rgba(255,255,255,0.04)",
              }}
            >
              {/* Toolbar */}
              ...
              <div className="relative" style={{ height: "55vh", minHeight: "460px" }}>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {/* Cover overlays */}
                    <div
                      className="absolute bottom-0 left-0 w-36 h-14 pointer-events-none"
                      style={{ background: "linear-gradient(135deg, #0a0e1a 60%, transparent)" }}
                    />
                    <div
                      className="absolute top-0 right-0 w-14 h-14 pointer-events-none"
                      style={{ background: "linear-gradient(225deg, #0a0e1a 40%, transparent)" }}
                    />
                  </motion.div>
                </AnimatePresence>
              </div>
              ...
              {/* Bottom Bar */}
              <div
                className="absolute bottom-0 left-0 right-0 z-20 flex items-center justify-between px-5 py-2.5 pointer-events-none"
              ...
              >
                ...
                <div className="flex items-center gap-3 text-[11px] text-gray-500 font-mono">
                  <span>
                    HR: <span className="text-emerald-400">{heartBeat}</span>
                  </span>
                  <span>
                    SpO₂: <span className="text-sky-400">98</span>%
                  </span>
                </div>
              </div>
                  ...
                  >
                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        <span
                          className={cn(
                            ...
                            organ.statusType === "optimal"
                              ? "bg-emerald-500"
                              : organ.statusType === "warning"
                                ? "bg-amber-500"
                                : "bg-sky-500",
                          )}
                        />
                    ...
                    <ChevronRight
                      className={cn(
                        ...
                        isActive ? "text-sky-500 rotate-90" : "text-slate-300",
                      )}
                    />
                  </button>
                );
