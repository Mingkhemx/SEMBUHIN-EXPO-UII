  ...
  head: () => ({
    meta: [
      { title: "Mental Health Care — Sembuhin" },
      {
        name: "description",
        content:
          "Screening PHQ-9 & GAD-7, CBT interaktif, dan video call AI terhubung ke psikolog.",
      },
    ],
  }),
...
> = {
  minimal: {
    ...
    label: "Minimal",
    description: "Gejala sangat ringan. Pertahankan kebiasaan sehat Anda.",
  },
  mild: {
    color: "text-sky-700",
    bgColor: "bg-sky-50 border-sky-200",
    label: "Ringan",
    description: "Gejala ringan. CBT dan self-care dapat membantu.",
  },
  moderate: {
    color: "text-amber-700",
    bgColor: "bg-amber-50 border-amber-200",
    label: "Sedang",
    description: "Disarankan konsultasi dengan psikolog.",
  },
  "mod-severe": {
    color: "text-orange-700",
    bgColor: "bg-orange-50 border-orange-200",
    label: "Cukup Berat",
    description: "Sangat disarankan konsultasi profesional.",
  },
  severe: {
    color: "text-red-700",
    bgColor: "bg-red-50 border-red-200",
    label: "Berat",
    description: "Segera hubungi psikolog atau layanan darurat.",
  },
};
    ...
    exercises: [
      {
        ...
        steps: [
          ...
          "Tarik napas melalui hidung — hitung sampai 4",
          "Tahan napas — hitung sampai 7",
          "Hembuskan perlahan melalui mulut — hitung sampai 8",
      ...
      },
      {
        ...
        steps: [
          "Tangan & lengan — tegangkan 5 detik, rileks 10 detik",
          "Bahu & leher — angkat ke telinga 5 detik, lepas",
          "Wajah — kerutkan semua otot 5 detik, rileks",
          "Perut — kencangkan 5 detik, lepas",
          "Kaki & jari kaki — tegangkan 5 detik, rileks",
        ],
      },
    ],
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        instruction:
          "Catat pikiran cemas Anda, tantang, dan ganti dengan pikiran yang lebih seimbang.",
      },
      {
        id: "worry-time",
        type: "journal",
        ...
        instruction:
          'Tuliskan semua kekhawatiran Anda. Simpan dalam "kotak" — Anda hanya boleh mengkhawatirkannya selama 15 menit besok.',
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        steps: [
          "Berbaring nyaman, lampu redup",
          "Tarik napas 4 detik",
          "Hembuskan 6 detik (lebih panjang)",
          "Fokus pada sensasi napas di perut",
          "Lakukan 5 menit sebelum tidur",
        ],
      },
      {
        id: "sleep-journal",
        ...
        title: "Sleep Diary",
        instruction:
          "Catat waktu tidur, bangun, kualitas tidur (1-5), dan aktivitas sebelum tidur.",
      },
      {
        id: "stimulus-control",
        type: "thought-record",
        ...
        instruction:
          "Tempat tidur hanya untuk tidur. Jika tidak bisa tidur 20 menit, pindah ke ruangan lain.",
      },
    ],
  },
  {
    ...
    exercises: [
      {
        ...
        instruction:
          'Saat menghadapi kesulitan, katakan pada diri sendiri: "Ini berat. Semua orang mengalami kesulitan. Saya boleh baik pada diri sendiri."',
      },
      {
        id: "gratitude",
        type: "journal",
      ...
      },
      {
        ...
        instruction:
          "Scan tubuh Anda. Di mana Anda merasakan emosi? Beri nama emosi tersebut tanpa menghakimi.",
        steps: [
          "Duduk tenang, pejamkan mata",
          "Scan tubuh dari kepala ke kaki",
          "Di mana Anda merasakan sensasi?",
          "Beri nama: cemas, sedih, marah, lelah...",
          'Katakan: "Saya merasa [emosi]. Itu valid."',
        ],
      },
    ],
  },
...
const VC_AI_SCRIPT: VCMessage[] = [
  {
    role: "ai",
    text: "Halo, saya Dr. Aura. Terima kasih sudah meluangkan waktu hari ini. Bagaimana perasaan Anda sekarang?",
  },
  {
    role: "ai",
    text: "Saya mengerti. Tidak apa-apa merasa seperti itu. Mari kita mulai dengan latihan pernapasan sederhana.",
  },
  { role: "ai", text: "Tarik napas perlahan melalui hidung... 1... 2... 3... 4..." },
  { role: "ai", text: "Tahan... 1... 2... 3... 4... 5... 6... 7..." },
  {
    role: "ai",
    text: "Hembuskan perlahan melalui mulut... 1... 2... 3... 4... 5... 6... 7... 8...",
  },
  { role: "ai", text: "Bagus. Ulangi sekali lagi. Kali ini lebih lambat dan lebih dalam." },
  {
    role: "ai",
    text: "Sekarang, ceritakan satu hal yang membuat Anda merasa tenang atau bahagia.",
  },
  { role: "ai", text: "Itu indah. Simpan perasaan itu. Anda bisa mengunjunginya kapan saja." },
  {
    role: "ai",
    text: "Untuk minggu ini, saya sarankan: 1) Latihan napas 5 menit setiap pagi, 2) Tuliskan 3 hal yang disyukuri sebelum tidur, 3) Jalan kaki 15 menit setiap hari.",
  },
  {
    role: "ai",
    text: "Anda sudah melakukan hal yang hebat hari ini. Jaga diri Anda baik-baik. Sampai jumpa di sesi berikutnya. 💙",
  },
];
...
function MentalHealthPage() {
  ...
  const severity =
    activeScreening === "phq9" ? getPHQ9Severity(totalScore) : getGAD7Severity(totalScore);
  ...
  const saveScreeningResult = async () => {
    ...
    try {
      ...
      alert(
        `Gagal menyimpan: ${err?.message || "Pastikan tabel mental_health_screenings sudah dibuat di Supabase."}`,
      );
    } finally {
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16 sm:py-20 space-y-6">
        ...
        >
          ...
          <div className="relative z-10 p-8 sm:p-12 max-w-2xl">
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight tracking-tight">
              Jaga Kesehatan
              <br className="hidden sm:block" /> Mental Anda
            </h1>
          ...
          >
            ...
            <div className="rounded-3xl bg-white/80 backdrop-blur-md border border-white/60 shadow-xl shadow-slate-200/60 p-6">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <button
                  ...
                  className="rounded-2xl bg-white border border-slate-100 shadow-sm p-6 text-left hover:shadow-md hover:border-violet-200 transition-all group"
                >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed mb-4">
                    Deteksi gejala depresi dalam 2 minggu terakhir.
                  </p>
                ...
                >
                  ...
                  <p className="text-sm text-slate-500 leading-relaxed mb-4">
                    Deteksi gejala gangguan kecemasan umum.
                  </p>
                  <div className="flex items-center gap-2 text-sm font-semibold text-violet-600 group-hover:text-violet-700">
                    Mulai{" "}
                    <ChevronRight className="h-4 w-4 transition-transform group-hover:translate-x-0.5" />
                ...
                {CBT_MODULES.map((mod) => {
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        setActiveCBT(mod);
                        setViewMode("cbt-detail");
                      }}
                      className="rounded-2xl bg-white border border-slate-100 shadow-sm p-5 hover:shadow-md hover:border-violet-200 transition-all text-left group"
                    >
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                          ...
                          <p className="text-[11px] text-slate-400">
                            {mod.exercises.length} latihan interaktif
                          </p>
                        </div>
                      </div>
            ...
            <div className="rounded-3xl bg-white/80 backdrop-blur-md border border-white/60 shadow-xl shadow-slate-200/60 p-2">
              <button
                ...
                className="w-full rounded-2xl bg-gradient-to-br from-violet-600 to-purple-700 text-white p-6 sm:p-8 shadow-lg shadow-violet-600/20 hover:shadow-xl transition-all text-left group"
              >
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-5">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-violet-100 mt-1 leading-relaxed">
                      Tatap muka virtual dengan Dr. Aura — AI therapist yang memandu Anda melalui
                      sesi konseling, latihan pernapasan, dan memberikan rekomendasi personal.
                    </p>
                  </div>
            ...
            <div className="rounded-3xl bg-white/80 backdrop-blur-md border border-white/60 shadow-xl shadow-slate-200/60 p-5 flex flex-col sm:flex-row items-start sm:items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  Konsultasi langsung dengan psikolog berlisensi. Aman dan rahasia.
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                <div className="flex items-center justify-between">
                  <span className="text-xs text-slate-500">
                    Pertanyaan{" "}
                    <span className="font-bold text-violet-600">{currentQuestion + 1}</span> dari{" "}
                    {questions.length}
                  </span>
                ...
                <div className="p-6 space-y-3">
                  ...
                  {ANSWER_OPTIONS.map((opt) => {
                    ...
                    const colorMap = {
                      emerald: {
                        selected:
                          "bg-emerald-50 border-emerald-400 text-emerald-800 shadow-emerald-100",
                        hover: "hover:border-emerald-300 hover:bg-emerald-50/50",
                        dot: "bg-emerald-500",
                      },
                      sky: {
                        selected: "bg-sky-50 border-sky-400 text-sky-800 shadow-sky-100",
                        hover: "hover:border-sky-300 hover:bg-sky-50/50",
                        dot: "bg-sky-500",
                      },
                      amber: {
                        selected: "bg-amber-50 border-amber-400 text-amber-800 shadow-amber-100",
                        hover: "hover:border-amber-300 hover:bg-amber-50/50",
                        dot: "bg-amber-500",
                      },
                      rose: {
                        selected: "bg-rose-50 border-rose-400 text-rose-800 shadow-rose-100",
          ...
          >
                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        key === severity ? cfg.bgColor : "bg-slate-50 border-slate-100",
                      )}
                    >
                      <span
                        className={cn(
                          "text-xs font-bold",
                          key === severity ? cfg.color : "text-slate-600",
                        )}
                      >
                        {cfg.label}
                      </span>
                      <span
                        className={cn(
                          "text-xs font-mono",
                          key === severity ? cfg.color : "text-slate-400",
                        )}
                      >
                        Skor {range}
                      </span>
            ...
            <div className="rounded-2xl bg-white border border-white/60 shadow-lg shadow-slate-200/60 p-6">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => {
                    setActiveCBT(CBT_MODULES[0]);
                    setViewMode("cbt-detail");
                  }}
                  className="flex items-start gap-3 p-3 rounded-xl bg-violet-50 border border-violet-200 text-left hover:bg-violet-100 transition-colors w-full group"
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-violet-700">
                      Coba Sesi CBT Interaktif
                    </p>
                    <p className="text-xs text-violet-600/80">
                      Latihan pernapasan, journaling, dan grounding
                    </p>
                  </div>
                ...
                <button
                  onClick={startVideoCall}
                  className="flex items-start gap-3 p-3 rounded-xl bg-sky-50 border border-sky-200 text-left hover:bg-sky-100 transition-colors w-full group"
                >
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-semibold text-sky-700">
                      Video Call dengan AI Therapist
                    </p>
                    <p className="text-xs text-sky-600/80">
                      Sesi konseling virtual dipandu Dr. Aura
                    </p>
                  </div>
                ...
                {(severity === "moderate" ||
                  ...
                  <Recommendation
                    icon={Users}
                    text="Konsultasi dengan psikolog profesional sangat disarankan"
                  />
                )}
              </div>
            </div>
              ...
              {savedScreening ? (
                <div className="flex items-center gap-3 text-emerald-600">
                  ...
                  <p className="text-sm font-semibold">
                    Hasil screening telah otomatis disimpan ke profil Anda.
                  </p>
                </div>
              ) : savingScreening ? (
                <div className="flex items-center gap-3 text-violet-600">
                  ...
                  <p className="text-sm font-semibold">
                    Menyimpan hasil ke profil secara otomatis...
                  </p>
                </div>
              ) : !user ? (
                <div className="flex items-center gap-3 text-rose-500">
                  ...
                  <p className="text-sm font-semibold">
                    Anda belum login, hasil tidak disimpan ke profil.
                  </p>
                </div>
              ) : null}
            </div>
            <div className="flex gap-3">
              <button
                onClick={goToLanding}
                className="flex-1 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 shadow-sm"
              >
                Kembali ke Menu
              </button>
              {(severity === "moderate" || severity === "mod-severe" || severity === "severe") && (
                <button className="flex-1 rounded-xl bg-violet-600 px-5 py-3 text-sm font-semibold text-white hover:bg-violet-700 shadow-md shadow-violet-600/20">
            ...
            <div className="flex gap-3 rounded-xl bg-white/80 border border-slate-200/80 p-4 shadow-sm">
              ...
              <p className="text-xs text-slate-500">
                Screening ini bersifat informatif dan bukan pengganti diagnosis klinis. Jika
                darurat, hubungi 119.
              </p>
            </div>
          </motion.div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        {activeCBT.exercises.length} latihan interaktif
                      </p>
                    </div>
                  </div>
                  <button
                  ...
                  {activeCBT.exercises.map((ex, i) => {
                    ...
                    return (
                      <button
                        ...
                        className="w-full rounded-2xl bg-white border border-white/60 shadow-lg shadow-slate-200/60 p-5 hover:shadow-xl hover:border-violet-200 transition-all text-left group"
                      >
                  ...
                  <div className="rounded-2xl bg-white border border-white/60 shadow-lg p-8 text-center">
                      ...
                      <div className="space-y-6">
                        <div>
                          ...
                          <p className="text-xs text-slate-400 mt-3">
                            {breathTarget} siklus × ~19 detik = ±
                            {Math.round((breathTarget * 19) / 60)} menit
                          </p>
                        </div>
                        <button
                          onClick={startBreathing}
                          className="inline-flex items-center gap-2 rounded-xl bg-violet-600 text-white px-8 py-4 text-base font-bold hover:bg-violet-700 shadow-lg shadow-violet-600/20"
                        >
                    ...
                    {breathing && (
                      <div className="space-y-6">
                        <motion.div
                          animate={{
                            scale: breathing === "in" ? 1.5 : breathing === "hold" ? 1.5 : 1,
                          }}
                          transition={{
                            duration: breathing === "in" ? 4 : breathing === "hold" ? 7 : 8,
                          }}
                            ...
                            <div
                              ...
                              className={cn(
                                ...
                                i < breathCount
                                  ...
                                  : i === breathCount
                                    ? "bg-violet-300 scale-110 animate-pulse"
                                    : "bg-slate-200",
                              )}
                            />
                          ))}
                        ...
                        <p className="text-sm text-slate-500">
                          Siklus {breathCount + 1} dari {breathTarget}
                        </p>
                      </div>
                    )}
                    {exerciseStep === 2 && (
                      <div className="space-y-4">
                        ...
                        <button
                          ...
                          className="rounded-xl bg-violet-600 text-white px-6 py-3 text-sm font-bold hover:bg-violet-700"
                        >
                          Selesai
                        </button>
                      </div>
                  ...
                  <div className="rounded-2xl bg-white border border-white/60 shadow-lg p-6">
                      ...
                      {activeExercise.steps.map((step, i) => (
                        ...
                        >
                          ...
                          <p
                            className={cn(
                              "text-sm",
                              exerciseStep >= i ? "text-slate-800 font-medium" : "text-slate-400",
                            )}
                          >
                            {step}
                          </p>
                    ...
                    <div className="mt-6 flex gap-3">
                      ...
                      {exerciseStep < (activeExercise.steps?.length || 0) - 1 ? (
                        <button
                          onClick={() => setExerciseStep((s) => s + 1)}
                          className="flex-1 rounded-xl bg-violet-600 text-white px-5 py-3 text-sm font-bold hover:bg-violet-700"
                        >
                          Selanjutnya
                        </button>
                      ) : (
                        <button
                          ...
                          className="flex-1 rounded-xl bg-emerald-600 text-white px-5 py-3 text-sm font-bold hover:bg-emerald-700"
                        >
                ...
                {activeExercise.type === "journal" && (
                  <div className="rounded-2xl bg-white border border-white/60 shadow-lg p-6">
                    <textarea
                      ...
                      rows={6}
                      className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400 resize-none"
                    />
                ...
                {activeExercise.type === "thought-record" && !activeExercise.steps && (
                  <div className="rounded-2xl bg-white border border-white/60 shadow-lg p-6">
                    ...
                    <div className="space-y-3">
                      <div>
                        <label className="text-xs font-medium text-slate-500 mb-1 block">
                          Pikiran negatif/cemas:
                        </label>
                        <textarea
                          rows={2}
                          placeholder="Apa yang saya pikirkan..."
                          className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 resize-none"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-medium text-slate-500 mb-1 block">
                          Tantangan pikiran tersebut:
                        </label>
                        <textarea
                          rows={2}
                          placeholder="Apakah pikiran ini realistis? Apa bukti sebaliknya?"
                          className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 resize-none"
                        />
                      </div>
                      <div>
                        <label className="text-xs font-medium text-slate-500 mb-1 block">
                          Pikiran yang lebih seimbang:
                        </label>
                        <textarea
                          rows={2}
                          placeholder="Pikiran yang lebih adil dan rasional..."
                          className="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 resize-none"
                        />
                      </div>
                    </div>
                    <button
                      ...
                      className="mt-4 w-full rounded-xl bg-violet-600 text-white px-5 py-3 text-sm font-bold hover:bg-violet-700"
                    >
                      <CheckCircle2 className="h-4 w-4 inline mr-1" /> Simpan & Selesai
                    </button>
                  </div>
        ...
        {viewMode === "video-call" && (
          ...
          >
            {/* Video Call UI */}
            <div
              className="rounded-2xl bg-slate-900 overflow-hidden shadow-2xl relative"
                ...
                {!vcStarted && (
                  <div className="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <p className="text-xs text-slate-500 mb-4">
                      Dr. Aura akan memandu Anda melalui sesi konseling.
                    </p>
                    <button
                      onClick={beginVCSession}
                      className="rounded-xl bg-violet-600 text-white px-6 py-3 text-sm font-bold hover:bg-violet-700 shadow-md shadow-violet-600/20"
                    >
              ...
              {vcStarted && (
                <div className="p-3 border-t border-slate-100">
                  <div className="flex gap-2">
                    <input
                      value={vcUserInput}
                      onChange={(e) => setVcUserInput(e.target.value)}
                      onKeyDown={(e) => e.key === "Enter" && sendVCUserMessage()}
                      placeholder="Ketik respons Anda..."
                      className="flex-1 rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500/30 focus:border-violet-400"
                    />
                    <button
                      onClick={sendVCUserMessage}
                      disabled={!vcUserInput.trim()}
                      className="flex h-10 w-10 items-center justify-center rounded-xl bg-violet-600 text-white hover:bg-violet-700 disabled:opacity-40 transition-all"
                    >
            ...
            <button
              onClick={goToLanding}
              className="w-full flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-5 py-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 shadow-sm"
            >
